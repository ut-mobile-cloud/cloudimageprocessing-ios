...
- (void)syncWithServer
{
	DLog(@"Syncing times with server : testID : %@", self.testID);
	...
	[request addPostValue:self.testID forKey:@"testID"];
	[request addPostValue:[self JSONRepresentation] forKey:@"clientTimes"];
